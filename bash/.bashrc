...
if [ "$color_prompt" = yes ]; then
   PS1='${debian_chroot:+($debian_chroot)}\[\033[37m\]\u@\h\[\033[00m\]:\[\033[01;33m\]\w\[\033[00m\]\$ '
else
...
if [ -x /usr/bin/dircolors ]; then
    test -r ~/.my-config/.dircolors && eval "$(dircolors -b ~/.my-config/.dircolors)" || eval "$(dircolors -b)"
